...
[Parameter Types](/documentation/shadergraph/procedural/image-file#Parameter-Types)
-----------------------------------------------------------------------------------
...
[See Also](/documentation/shadergraph/procedural/image-file#see-also)
---------------------------------------------------------------------

### [Nodes](/documentation/shadergraph/procedural/image-file#nodes)
