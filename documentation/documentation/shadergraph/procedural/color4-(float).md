...
[Parameter Types](/documentation/shadergraph/procedural/color4-(float)#Parameter-Types)
---------------------------------------------------------------------------------------
...
[See Also](/documentation/shadergraph/procedural/color4-(float)#see-also)
-------------------------------------------------------------------------

### [Nodes](/documentation/shadergraph/procedural/color4-(float)#nodes)
