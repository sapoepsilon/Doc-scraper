...
[Overview](/documentation/shadergraph/math#overview)
----------------------------------------------------
...
[Topics](/documentation/shadergraph/math#topics)
------------------------------------------------

### [Nodes](/documentation/shadergraph/math#nodes)
...
[`One Minus (Reality Kit)`](/documentation/shadergraph/math/one-minus-(realitykit))
