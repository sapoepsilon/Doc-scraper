...
[Parameter Types](/documentation/shadergraph/math/rotate-2d#Parameter-Types)
----------------------------------------------------------------------------
...
[Parameter descriptions](/documentation/shadergraph/math/rotate-2d#Parameter-descriptions)
------------------------------------------------------------------------------------------
...
`Amount` 
 ...
 `In` 
 vector. A positive value rotates the
 `In` 
 vector counterclockwise. The default value is
 `0` 
 .
...
[See Also](/documentation/shadergraph/math/rotate-2d#see-also)
--------------------------------------------------------------

### [Nodes](/documentation/shadergraph/math/rotate-2d#nodes)
