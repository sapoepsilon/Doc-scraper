...
[Parameter Types](/documentation/shadergraph/math/fractional-(realitykit)#Parameter-Types)
------------------------------------------------------------------------------------------
...
[See Also](/documentation/shadergraph/math/fractional-(realitykit)#see-also)
----------------------------------------------------------------------------

### [Nodes](/documentation/shadergraph/math/fractional-(realitykit)#nodes)
