...
[Parameter Types](/documentation/shadergraph/math/one-minus-(realitykit)#Parameter-Types)
-----------------------------------------------------------------------------------------
...
[See Also](/documentation/shadergraph/math/one-minus-(realitykit)#see-also)
---------------------------------------------------------------------------

### [Nodes](/documentation/shadergraph/math/one-minus-(realitykit)#nodes)
