...
[Parameter Types](/documentation/shadergraph/realitykit/camera-position-(realitykit)#Parameter-Types)
-----------------------------------------------------------------------------------------------------
...
[Parameter description](/documentation/shadergraph/realitykit/camera-position-(realitykit)#Parameter-description)
-----------------------------------------------------------------------------------------------------------------

`Space` 

 The space that establishes the camera’s position. This parameter can be equal to
 `world` 
 ,
 `tangent` 
 ,
...
[See Also](/documentation/shadergraph/realitykit/camera-position-(realitykit)#see-also)
---------------------------------------------------------------------------------------

### [Nodes](/documentation/shadergraph/realitykit/camera-position-(realitykit)#nodes)
