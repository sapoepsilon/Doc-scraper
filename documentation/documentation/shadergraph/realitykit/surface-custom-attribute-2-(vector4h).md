...
[Parameter Types](/documentation/shadergraph/realitykit/surface-custom-attribute-2-(vector4h)#Parameter-Types)
--------------------------------------------------------------------------------------------------------------

| Output | Type |
| --- | --- |
| `Custom Attribute` | Vector4h |

[Discussion](/documentation/shadergraph/realitykit/surface-custom-attribute-2-(vector4h)#Discussion)
----------------------------------------------------------------------------------------------------
...
[See Also](/documentation/shadergraph/realitykit/surface-custom-attribute-2-(vector4h)#see-also)
------------------------------------------------------------------------------------------------

### [Nodes](/documentation/shadergraph/realitykit/surface-custom-attribute-2-(vector4h)#nodes)
