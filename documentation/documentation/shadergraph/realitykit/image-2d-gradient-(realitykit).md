...
[Parameter Types](/documentation/shadergraph/realitykit/image-2d-gradient-(realitykit)#Parameter-Types)
-------------------------------------------------------------------------------------------------------
...
[Parameter descriptions](/documentation/shadergraph/realitykit/image-2d-gradient-(realitykit)#Parameter-descriptions)
---------------------------------------------------------------------------------------------------------------------
...
[Discussion](/documentation/shadergraph/realitykit/image-2d-gradient-(realitykit)#Discussion)
---------------------------------------------------------------------------------------------
...
[See Also](/documentation/shadergraph/realitykit/image-2d-gradient-(realitykit)#see-also)
-----------------------------------------------------------------------------------------

### [Nodes](/documentation/shadergraph/realitykit/image-2d-gradient-(realitykit)#nodes)
