...
[Parameter Types](/documentation/shadergraph/realitykit/occlusion-surface-(realitykit)#Parameter-Types)
-------------------------------------------------------------------------------------------------------
...
[See Also](/documentation/shadergraph/realitykit/occlusion-surface-(realitykit)#see-also)
-----------------------------------------------------------------------------------------

### [Nodes](/documentation/shadergraph/realitykit/occlusion-surface-(realitykit)#nodes)
