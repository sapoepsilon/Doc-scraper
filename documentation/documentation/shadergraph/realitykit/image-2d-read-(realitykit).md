...
[Parameter Types](/documentation/shadergraph/realitykit/image-2d-read-(realitykit)#Parameter-Types)
---------------------------------------------------------------------------------------------------

* [Image 2D Read (vector4)](#)
...
[Parameter description](/documentation/shadergraph/realitykit/image-2d-read-(realitykit)#Parameter-description)
---------------------------------------------------------------------------------------------------------------
 ...
 The
 *X* 
 position of the pixel that the node reads.
...
[Discussion](/documentation/shadergraph/realitykit/image-2d-read-(realitykit)#Discussion)
-----------------------------------------------------------------------------------------
...
[See Also](/documentation/shadergraph/realitykit/image-2d-read-(realitykit)#see-also)
-------------------------------------------------------------------------------------

### [Nodes](/documentation/shadergraph/realitykit/image-2d-read-(realitykit)#nodes)
