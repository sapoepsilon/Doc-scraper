# surface-custom-attribute-realitykit


[Parameter Types](/documentation/shadergraph/realitykit/surface-custom-attribute-(realitykit)#Parameter-Types)
--------------------------------------------------------------------------------------------------------------

| Output | Type |
| --- | --- |
| `Custom Attribute` | Vector4f |

[Discussion](/documentation/shadergraph/realitykit/surface-custom-attribute-(realitykit)#Discussion)
----------------------------------------------------------------------------------------------------
...
[See Also](/documentation/shadergraph/realitykit/surface-custom-attribute-(realitykit)#see-also)
------------------------------------------------------------------------------------------------

### [Nodes](/documentation/shadergraph/realitykit/surface-custom-attribute-(realitykit)#nodes)
